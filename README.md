...
4. Поправить все по комментариям Светланы за 2 урок
5. Расширение (использование стилей какого-то класса для другой компоненты) - 15:00 видео
6. Hover на псевдоэлементы - 18:40 видео
7. container стиль писать через расширение (23:10)
8. !!! При установки какой-либо библиотеки искать ее версию для реакта, иначе не будет работать
9. стилистика спана в библиотеке typing text - 1:03
10. стилистика цветов блоков (переменно меняются), как задать без дублирования кода - 1:06 
11. сайт "can i use" - там можно посмотреть какое свойство в каком браузере используется (для проверки кроссбраузерности)
